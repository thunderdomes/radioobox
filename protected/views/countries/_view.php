...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('world_region_id')); ?>:</b>
	<?php echo CHtml::encode($data->world_region_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('locations_count')); ?>:</b>
	<?php echo CHtml::encode($data->locations_count); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('polygon')); ?>:</b>
	<?php echo CHtml::encode($data->polygon); ?>
	<br />
